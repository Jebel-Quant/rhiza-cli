...
from rhiza.commands.summarise import SummariseOptions, summarise
...
class TestSummariseCommand:
    ...
    def test_summarise_no_header(self, git_repo, capsys):
        ...
        summarise(git_repo, options=SummariseOptions(include_header=False))
    ...
    def test_summarise_no_footer(self, git_repo, capsys):
        ...
        summarise(git_repo, options=SummariseOptions(include_footer=False))
    ...
    def test_summarise_no_categories(self, git_repo, capsys):
        ...
        summarise(git_repo, options=SummariseOptions(include_categories=False))
    ...
    def test_summarise_format_json(self, git_repo, capsys):
        ...
        summarise(git_repo, options=SummariseOptions(output_format="json"))
    ...
    def test_summarise_custom_title(self, git_repo, capsys):
        ...
        summarise(git_repo, options=SummariseOptions(title="## My Custom Title"))
    ...
    def test_summarise_compare_ref(self, git_repo, capsys):
        ...
        summarise(git_repo, options=SummariseOptions(compare_ref="HEAD"))
    ...
    def test_summarise_jinja2_template(self, git_repo, tmp_path, capsys):
        ...
        summarise(git_repo, options=SummariseOptions(jinja2_template=jinja_tmpl))
