...
class TestCloneAndResolveUpstreamWithTemplates:
    ...
    def test_bundle_resolution_path(
        ...
        upstream_dir, upstream_sha, resolved_template = template.clone(git_ctx, branch="main")
        ...
        # original template is unchanged; resolved_template carries the new paths
...
class TestThreeWayMergeWithBase:
    ...
    def test_merge_applies_upstream_changes(self, mock_clone, tmp_path, git_project, git_ctx):
        ...
        def populate_base_clone(sha, dest, include_paths, git_ctx_):
...
class TestCloneTemplateRepository:
    ...
    Note: _clone_template_repository is now a private method on RhizaTemplate.
