...
<body>
    ...
    <script>
        ...
        function updateStats() {
            ...
            document.getElementById('ahead-repos').textContent = repos.filter(
                r => r.status === 'ahead' || r.status === 'diverged'
            ).length;
            document.getElementById('behind-repos').textContent = repos.filter(
                r => r.status === 'behind' || r.status === 'diverged'
            ).length;
        }
                ...
                <div class="repo-card">
                    ...
                    <div class="repo-actions">
                        <button class="btn btn-primary btn-sm"
                                onclick="execGitOp('${repo.name}', 'fetch')">Fetch</button>
                        ...
                        <button class="btn btn-primary btn-sm"
                                onclick="execGitOp('${repo.name}', 'status')">Status</button>
